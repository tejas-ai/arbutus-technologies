        ...
        <html>
            <body>
                <div className="min-h-screen bg-bg text-text flex flex-col items-center justify-center p-8">
                    <h1 className="text-4xl font-bold text-red-500 mb-4">A Fatal Error Occurred</h1>
                    ...
                    <p className="mt-4 text-muted max-w-lg text-center">
                        This error boundary caught a layout crash. Please report this message.
                    </p>
                </div>
            </body>
        </html>
